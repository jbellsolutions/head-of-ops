...
| Slack app is missing commands or scopes | The starter manifest was not applied or the app was not reinstalled | Apply `/srv/<operator>/hermes/data/slack-manifest.json`, save, and reinstall when Slack prompts |
